import {getDefaultImage, isValidImage, getImage} from './imageHelpers';
import {getComments, postComment} from '../api/comments';
import pictures from '../assets/pictures';
import {deleteVote, getVotes, putVote} from '../api/votes';
import {getLocalStorageUser} from '../util/storageManager';
...
const buildCommentButtonContainer = (voteCount, commentId, isVoted) => {
  ...
  upvoteButton.innerHTML = `&#x25B2; Upvote (${voteCount})`;
